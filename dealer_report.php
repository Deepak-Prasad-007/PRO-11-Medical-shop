...
<body>
	...
	<div id="body">
		<div class="content">
			...
			<h2>Dealer report</h2>
<form method="post" action="dealer_report.php">
          <table border="1" width="90%">
               <tr>
                   <td></td>
                <td><b>Dealer ID</b></td>
                <td><b>Dealer name</b></td>
                <td><b>medicine company</b></td>
                 <td><b>phone no</b></td>
                 <td><b>email</b></td>
                 <td><b>address</b></td>
                 <td><b>pincode</b></td>
                ...
                $result=mysql_query("Select * from dealer_details",$db);
                while($row= mysql_fetch_array($result))
                {
                    ?>
                <tr>
                    <td><a href ="edit_dealer.php?id=<?php echo $row[0]?>">edit</td>
