...
<form method="post" action="op_report.php">
          <table border="1" width="80%">
               <tr>
                   <td></td>
                <td><b>operator code</b></td>
                ...
                $result=mysql_query("Select * from operator_details",$db);
                while($row= mysql_fetch_array($result))
                {
                    ?>
                <tr>
                    <td><a href ="edit_operator.php?id=<?php echo $row[0]?>"</a>edit</td>
