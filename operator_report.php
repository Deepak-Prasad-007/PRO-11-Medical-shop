...
<form method="post" action="operator_report.php">

        <br><br>
            <table width="110%">
                <tr>
                    <a href="customer_report.php">customer report</a><br>
                    <a href="purchase_report.php"> purchase report</a><br>
                    <a href="medicine_report.php">Medicine report</a><br>
